...
# terraform import google_compute_subnetwork.loadbalancer_vpc projects/loadbalancer-demo-468117/regions/northamerica-south1/subnetworks/loadbalancer-vpc
