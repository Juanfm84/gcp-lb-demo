resource "google_compute_instance" "web_instance_1" {
  boot_disk {
    ...
    mode   = "READ_WRITE"
    source = "https://www.googleapis.com/compute/v1/projects/loadbalancer-demo-468117/zones/us-west1-b/disks/web-instance-1"
  }
...
# terraform import google_compute_instance.web_instance_1 projects/loadbalancer-demo-468117/zones/us-west1-b/instances/web-instance-1
