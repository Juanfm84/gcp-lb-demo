...
# terraform import google_compute_subnetwork.loadbalancer_vpc projects/loadbalancer-demo-468117/regions/australia-southeast2/subnetworks/loadbalancer-vpc
